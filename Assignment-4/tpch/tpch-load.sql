...
COPY region FROM '/Users/amol/git/umd-classes/cmsc724-spring2022/Assignment-4/tpch/tables/region.tbl' WITH DELIMITER AS '|';
COPY nation FROM '/Users/amol/git/umd-classes/cmsc724-spring2022/Assignment-4/tpch/tables/nation.tbl' WITH DELIMITER AS '|';
COPY part FROM '/Users/amol/git/umd-classes/cmsc724-spring2022/Assignment-4/tpch/tables/part.tbl' WITH DELIMITER AS '|';
COPY supplier FROM '/Users/amol/git/umd-classes/cmsc724-spring2022/Assignment-4/tpch/tables/supplier.tbl' WITH DELIMITER AS '|';
COPY partsupp FROM '/Users/amol/git/umd-classes/cmsc724-spring2022/Assignment-4/tpch/tables/partsupp.tbl' WITH DELIMITER AS '|';
COPY customer FROM '/Users/amol/git/umd-classes/cmsc724-spring2022/Assignment-4/tpch/tables/customer.tbl' WITH DELIMITER AS '|';
COPY orders FROM '/Users/amol/git/umd-classes/cmsc724-spring2022/Assignment-4/tpch/tables/orders.tbl' WITH DELIMITER AS '|';
COPY lineitem FROM '/Users/amol/git/umd-classes/cmsc724-spring2022/Assignment-4/tpch/tables/lineitem.tbl' WITH DELIMITER AS '|';
